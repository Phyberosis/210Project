...
import game.mechanics.GraphicsHandler;
import game.mechanics.KeyHandler;
import game.mechanics.LogicHandler;
import game.mechanics.MouseHandler;
...
//        Scene s = sceneMap.get(newScene);
        Platform.runLater(() -> {
            currentScene = s;
            stage.setScene(s);
            s.setOnKeyPressed(new KeyHandler(EatGame.this));
        });
    }
